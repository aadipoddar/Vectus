...
public partial class DepartmentPage
{
	...
	private async Task DeleteTransaction(int id)
	{
		try
		{
			...
			await DepartmentData.DeleteTransaction(department, _user.Id, FormFactor.GetFormFactor() + FormFactor.GetPlatform());
	...
	private async Task RecoverTransaction(int id)
	{
		try
		{
			...
			await DepartmentData.RecoverTransaction(department, _user.Id, FormFactor.GetFormFactor() + FormFactor.GetPlatform());
	...
	private async Task ExportExcel()
	{
		...
		try
		{
			...
			var (stream, fileName) = await DepartmentExport.ExportMaster(_departments, ReportExportType.Excel);
	...
	private async Task ExportPdf()
	{
		...
		try
		{
			...
			var (stream, fileName) = await DepartmentExport.ExportMaster(_departments, ReportExportType.PDF);
			await SaveAndViewService.SaveAndView(fileName, stream);

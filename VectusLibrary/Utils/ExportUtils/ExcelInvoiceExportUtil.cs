...
namespace VectusLibrary.Utils.ExportUtils;
...
public static class ExcelInvoiceExportUtil
{
        ...
        Dictionary<string, string> summaryFields = null) where T : class
    {
        ...
        try
        {
            ...
            workbook.BuiltInDocumentProperties.Author = $"{Secrets.DatabaseName}";
    ...
    private static async Task<int> DrawInvoiceHeader(IWorksheet worksheet, int startRow)
    {
        ...
        try
        {
            const string logoResourceName = "VectusLibrary.Exports.Resources.logo_full.png";
